...
public class RunSpecification implements Specification<Run> {
	
    public RunSpecification(SpecSearchCriteria criteria) {
		super();
    ...
    public Predicate toPredicate(
      Root<Run> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
